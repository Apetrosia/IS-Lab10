...
namespace AForge.WindowsForms
{
    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            TLGBotik = new TLGBotik(controller.settings, new TLGBotik.TalkToAIML(AIMLBotik.Talk));
            TLGBotik.StartReceiving();
        }
        ...
        private void video_NewFrame(object sender, NewFrameEventArgs eventArgs)
        {
            ...
            if(controller.Ready)
                ...
                controller.ProcessImage((Bitmap)eventArgs.Frame.Clone(), true);
        ...
        {
            controller.processor.student = checkBox1.Checked;
        }
    }
}
